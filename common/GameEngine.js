...
function(Player, WeaponFactory, MathUtils, Utils){
	...
	return CJ.namespace(ns, 
		function(){
			var Player = new CJ.Actors.Player();
				
			var board = {
				'height': 0, 'width': 0, 
				'players': new CJ.Utils.JsDictionary(), 
				'effects': new CJ.Utils.JsDictionary(),
				'hazards': new CJ.Utils.JsDictionary(),
				'weapons': new CJ.Utils.JsDictionary()
			}
			...
			this.addPlayer = function(id, playerConfig){
			...
			this.createPlayer = function(id, playerConfig){
			...
			this.drawBoardObjects = function(ctx){
			...
			this.initBoard = function(boardObj, playerId){
			...
			this.onKeyPressed = function(playerId, keysPressed){
			...
			this.processBoardObjects = function(){
